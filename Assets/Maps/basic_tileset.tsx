...
<tileset version="1.2" tiledversion="1.2.4" name="basic_tileset" tilewidth="16" tileheight="16" spacing="1" tilecount="1767" columns="57">
 <image source="../Sprites/Map/basic_tileset.png" width="968" height="526"/>
 <terraintypes>
  <terrain name="water" tile="2"/>
  <terrain name="dirt_path" tile="2"/>
 </terraintypes>
 <tile id="2" terrain=",,,0"/>
